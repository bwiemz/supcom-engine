...
OP_BOR,/*	A B C	R(A) := RK(B) | RK(C)	(LuaPlus)		*/
OP_BAND,/*	A B C	R(A) := RK(B) & RK(C)	(LuaPlus)		*/
OP_SHL,/*	A B C	R(A) := RK(B) << RK(C)	(LuaPlus)		*/
OP_SHR,/*	A B C	R(A) := RK(B) >> RK(C)	(LuaPlus)		*/
OP_UNM,/*	A B	R(A) := -R(B)					*/
OP_NOT,/*	A B	R(A) := not R(B)				*/
OP_LEN,/*	A B	R(A) := #R(B)	(LuaPlus)			*/
