...
| Benchmark (Release, four retail AIs, SCMP_009) | About 21 s for 6,000 ticks (it was 25.2 s before M205's path-cost fix). An 18,000-tick game runs without Lua errors. Its sim took about 256 s after M224b, against 450 s before M224 (compiled category matching, then unit-only radius queries; measured side by side). Since M224d (emitters end) the whole run takes 108 s, against 147 s on main just before it. Late ticks are the slow ones: at 1,700–1,800 units, about 33 ms a tick. |
