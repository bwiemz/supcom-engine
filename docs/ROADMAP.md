...
| B | **In progress.** M184–M188 are done (PRs #20–#25 and the M188 branch). The retail gate went from 44 to all 99 data modes, and `retail-gap` is empty; `tests/integration/data_tests.cmake` records each step. Next: M189 (script-owned rules). |
| C–I | Not started. |
