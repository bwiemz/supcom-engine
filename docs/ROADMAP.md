...
| B | **In progress.** M184–M187 are done (PRs #20–#24 and the M187c branch). The retail gate went from 44 to all 99 data modes, and `retail-gap` is empty; `tests/integration/data_tests.cmake` records each step. Next: M188 (audio parity). |
| C–I | Not started. |
